...
Vì nó nói lên các giá trị thông tin nên sẽ được đặt ở `private` để ngăn chặn việc truy cập trực tiếp đối tượng.

Thế thì muốn lấy thông tin hoặc chỉnh sửa phần thuộc tính từ bên ngoài thì sẽ như thế nào? Ta sẽ thông qua hai *phương thức* là getter và setter. 
...
# Thực hành thôi ! (fork from huaanhminh)
...
Chia sẽ nếu bạn thấy hay. Xin cảm ơn.
