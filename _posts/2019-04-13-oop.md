...
> Data hiding: Ẩn dữ liệu của đối tượng - giống như việc **tiền vào tay vợ** thì sẽ **auto bị ẩn đi** và nếu muốn sử dụng ( truy cập ) chúng, ta phải thông qua vợ ( phương thức ).
